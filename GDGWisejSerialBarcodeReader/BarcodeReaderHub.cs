...
namespace GDGWisejSerialBarcodeReader
{
    ...
    /// </summary>
    public static class BarcodeReaderHub
    {
        /// <summary>
        /// Evento broadcast: ricevuto da tutti i sottoscrittori,
        /// solo se nessun listener esclusivo è attivo.
        /// </summary>
        public static event EventHandler<BarcodeReader.BarcodeScannedEventArgs> BarcodeScanned;

        // Handler esclusivo corrente (null = nessuno)
        private static EventHandler<BarcodeReader.BarcodeScannedEventArgs> _exclusiveHandler;

        /// <summary>
        /// Acquisisce il diritto esclusivo di ricevere l'evento.
        /// Sostituisce qualsiasi lock esclusivo precedente.
        /// </summary>
        public static void AcquireExclusive(EventHandler<BarcodeReader.BarcodeScannedEventArgs> handler)
        {
        ...
        /// </summary>
        public static void ReleaseExclusive(EventHandler<BarcodeReader.BarcodeScannedEventArgs> handler)
        {
        ...
        /// </summary>
        public static void RaiseBarcodeScanned(object sender, BarcodeReader.BarcodeScannedEventArgs e)
        {
